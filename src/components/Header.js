...
function Header() {
    return (<div className="header">
            <div style={{ display:'flex',width:'70%',height:'100%',justifyContent:'space-between',alignItems:'center'}}>
                ...
                <FontAwesomeIcon icon={faMagnifyingGlass} size="xl" style={{color: "#ffffff",}} /> <input type='text' placeholder='Tìm kiếm bài hát, playlist, nghệ sĩ,...' style={{background:'none',border:'none',color:'white'}}></input>
            </div>
            </div>
